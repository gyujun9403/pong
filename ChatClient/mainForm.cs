...
namespace csharp_test_client
{
    public partial class mainForm : Form
    {
        ...
        static bool readyBtn = false;
        public void syncReadyBtn()
        {
            if (readyBtn == false)
            {
            ...
            {
                this.btnRoomRelay.Text = "Waiting...";
            }
        }
        private void btnRoomRelay_Click(object sender, EventArgs e) // 레디로 변경.
        {
            //this.btnRoomRelay.Text = ""
            var requestPkt = new RoomReadyReqPacket();
            requestPkt.setReady(!readyBtn);
            PostSendPacket(PACKET_ID.ROOM_READY_REQ, requestPkt.ToBytes());
            DevLog.Write($"방 채팅 요청");
        }
